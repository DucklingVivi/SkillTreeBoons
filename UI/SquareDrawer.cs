...
namespace SkillTreeBoons.UI
{
    public class SquareDrawer
    {
        ...
        public static void drawSquare(Vector2 position, float size, Microsoft.Xna.Framework.Color color, float rot, float linethickness = 10f)
        {
            ...
            object[] curveData = calcSquareVerticies(position, size, rot, linethickness);
        ...
        public static object[] calcSquareVerticies(Vector2 position, float size, float rotation, float thickness)
        {
            ...
            {
                Vector2 normal;
                float theta = i * angle + rotation + (float)Math.PI/4;
